          ...
          <section className="flex">
            <div className="relative w-full flex flex-col justify-center px-8 py-5 overflow-hidden">
              ...
              <div className="relative z-10 p-5 rounded-lg pb-12">
                ...
                <h1 className="text-center text-3xl font-semibold mb-3 text-[#303030]">¡Hola! ¿Eres nuevo por aquí?</h1>
                <h6 className="text-center font-light text-sm mb-6 text-gray-400">Ingresa tus datos, por favor</h6>
                <form className="space-y-4 flex flex-col items-center">
                  ...
                  <div className="flex flex-col justify-end items-center">
                    <Link to="/dashboard" className="transition ease-in-out delay-150 bg-slate-800 hover:-translate-y-1 hover:scale-110 hover:bg-slate-900 duration-300 w-64 py-1.5 px-2 mt-4 text-white rounded-md font-regular">
                      Registrarse
                    </Link>
                  </div>
                </form>
